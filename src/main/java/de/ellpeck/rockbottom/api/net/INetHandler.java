...
public interface INetHandler {
    ...
    /**
     * Sends an {@link IPacket} to all the players in the same world, meaning
     ...
     * @param packet The packet to send
     */
    void sendToAllPlayersInSameWorld(IWorld world, IPacket packet);

    /**
     * Sends an {@link IPacket} to all of the players in the same world except
     * one. This can be useful for if a packet is being sent from a player that
     * already has a certain bit of information, possibly from having sent it to
     * the server prior.
     *
     * @param world  The world
     ...
     * @param except The player that the packet should not be sent to
     */
    void sendToAllPlayersInSameWorldExcept(IWorld world, IPacket packet, Entity except);
