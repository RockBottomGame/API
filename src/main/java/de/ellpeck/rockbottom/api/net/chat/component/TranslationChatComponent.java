...
public class TranslationChatComponent extends ChatComponent {

    private ResourceName key;
    private String[] formatting;

    public TranslationChatComponent() {
    }

    public TranslationChatComponent(ResourceName key, String... formatting) {
        this.key = key;
