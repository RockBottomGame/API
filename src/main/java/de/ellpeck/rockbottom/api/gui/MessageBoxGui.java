...
public class MessageBoxGui extends Gui {
    ...
    public MessageBoxGui(int boxWidth, ChatComponent message) {
        this(null, boxWidth, message);
    }

    public MessageBoxGui(Gui parent, int boxWidth, ChatComponent message) {
    ...
    public void init(IGameInstance game) {
        ...
        this.components.add(new MessageBoxComponent(this, this.width / 2 - this.boxWidth / 2, this.height - height - this.heightOffset, this.boxWidth, height, message, this.scale, true, true, () -> {
