...
public class MessageBoxComponent extends GuiComponent {
    ...
    public MessageBoxComponent(Gui gui, int x, int y, int width, int height, String message, float scale, boolean hasBackground, boolean appearsSlowly, Supplier<Boolean> supplier) {
