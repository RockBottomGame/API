...
public class SliderComponent extends ButtonComponent {
    ...
    public SliderComponent(Gui gui, int x, int y, int sizeX, int sizeY, int initialNumber, int min, int max, BiConsumer<Integer, Boolean> consumer, String text, String... hover) {
