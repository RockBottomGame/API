/*
 * This file ("RestrictedInputSlot.java") is part of the RockBottomAPI by Ellpeck.
...
public class RestrictedInputSlotContainer extends SlotContainer {
    ...
    public RestrictedInputSlotContainer(IFilteredInventory inventory, int slot, int x, int y) {
