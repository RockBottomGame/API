...
public class ToggleButtonComponent extends ButtonComponent {
    ...
    public ToggleButtonComponent(Gui gui, int x, int y, int sizeX, int sizeY, boolean defaultState, Supplier<Boolean> supplier, String locKey, String... hover) {
        this(gui, x, y, sizeX, sizeY, defaultState, supplier, RockBottomAPI.getGame(), locKey, hover);
    }

    public ToggleButtonComponent(Gui gui, int x, int y, int sizeX, int sizeY, boolean defaultState, Supplier<Boolean> supplier, IMod locDomain, String locKey, String... hover) {
