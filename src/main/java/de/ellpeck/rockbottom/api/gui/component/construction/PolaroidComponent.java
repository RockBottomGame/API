...
public class PolaroidComponent extends GuiComponent {
	...
	public PolaroidComponent(Gui gui, ICompendiumRecipe recipe, boolean canConstruct, ResourceName tex) {
		super(gui, 0, 0, 18, 20);
		this.recipe = recipe;
    ...
    public PolaroidComponent(Gui gui, ICompendiumRecipe recipe, boolean canConstruct) {
        this(gui, recipe, canConstruct, DEFAULT_TEX);
    }

    public static PolaroidComponent getUnknown(Gui gui, ResourceName tex) {
    	return new PolaroidComponent(gui, null, false, tex);
	}
