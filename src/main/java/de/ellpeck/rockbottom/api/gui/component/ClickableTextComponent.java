...
public class ClickableTextComponent extends GuiComponent {

    private final float scale;
    private final String[] text;
    private final Supplier<Boolean> clickSupplier;

    public ClickableTextComponent(Gui gui, int x, int y, float scale, boolean fromRight, Supplier<Boolean> clickSupplier, String... text) {
        super(gui, x, y, 0, 0);
        this.scale = scale;
        this.text = text;
