...
public class BasicToast implements IToast {
    ...
    public BasicToast(ChatComponent title, ChatComponent description, int displayTime) {
        this(null, title, description, displayTime);
    }

    public BasicToast(ResourceName icon, ChatComponent title, ChatComponent description, int displayTime) {
        this.icon = icon;
        this.title = title;
